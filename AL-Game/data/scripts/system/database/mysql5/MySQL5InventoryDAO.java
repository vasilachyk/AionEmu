...
public class MySQL5InventoryDAO extends InventoryDAO {
	...
	private Item constructItem(final int storage, ResultSet rset) throws SQLException {
		...
		optionalFusionSocket, charge, randomBonus, rndCount, wrappingCount, isPacked == 1, temperingLevel, isTopped == 1, strengthenSkill, skinSkill, isLunaReskin == 1, reductionLevel, unSeal);
		return item;
	}
