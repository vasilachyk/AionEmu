...
public class _10529Protection_Artifact_2 extends QuestHandler
{
	...
	private final static int[] LF6MissionDarkFi75An = {244111}; //그림자 아칸 전투병.
	private final static int[] LF6MissionDarkWi75An = {244112}; //그림자 아칸 마법병.
    ...
    public boolean onKillEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
            int var = qs.getQuestVarById(0);
            if (var == 6) {
				int[] LF6MissionDarkFi75An = {244111}; //그림자 아칸 전투병.
				int[] LF6MissionDarkWi75An = {244112}; //그림자 아칸 마법병.
				switch (targetId) {
