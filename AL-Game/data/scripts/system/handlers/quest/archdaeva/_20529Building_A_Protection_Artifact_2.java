...
public class _20529Building_A_Protection_Artifact_2 extends QuestHandler
{
	...
	private final static int[] DF6MissionLightFi75An = {244127}; //그림자 아칸 전투병.
	private final static int[] DF6MissionLightWi75An = {244128}; //서광의 가디언 마법병.
    ...
    public boolean onKillEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
            int var = qs.getQuestVarById(0);
            if (var == 6) {
				int[] DF6MissionLightFi75An = {244127}; //서광의 가디언 전투병.
				int[] DF6MissionLightWi75An = {244128}; //서광의 가디언 마법병.
				switch (targetId) {
