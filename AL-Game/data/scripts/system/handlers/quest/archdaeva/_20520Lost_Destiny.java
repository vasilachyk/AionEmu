...
public class _20520Lost_Destiny extends QuestHandler
{
    ...
    public boolean onEnterWorldEvent(QuestEnv env) {
        ...
        if (player.getRace() == Race.ASMODIANS && player.getWorldId() == 120010000 &&player.getLevel() == 65 && player.getInventory().getItemCountByItemId(itemId) == 0) { // get Item by Level and Check Item if item is null.
        	QuestService.startQuest(env);
            SystemMailService.getInstance().sendMail("Munin", name, title, messages, itemId, 1, 0, LetterType.NORMAL);
