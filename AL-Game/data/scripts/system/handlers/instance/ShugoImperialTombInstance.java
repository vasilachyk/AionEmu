...
public class ShugoImperialTombInstance extends GeneralInstanceHandler
{
   ...
   /**
	* Rewards (Update to 4.3!)
	* Here is a list of items you can get.
	*
	* Note that you need one key for a small chest and three keys for a big chest.
    * Ceranium Medals
    * Mithril Medals
    * Ancient Coins
    * Abyssal Relics
    * AP Crowns
    * Blessed Manastone Socketing Supplement (Fabled)
    * Blessed Manastone Socketing Supplement (Eternal)
    * Blessed Manastone Socketing Supplement (Mythic)
    * A temporary pet named Acarun, which produces Composite Manastones of L60
    * Crystal Shield
    * A Cloud mount
    * Dramata's Wings
