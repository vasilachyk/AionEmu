...
public class EsoterraceInstance extends GeneralInstanceHandler
{
    ...
    public void onDie(Npc npc) {
		...
		switch (npc.getObjectTemplate().getTemplateId()) {
			 ...
			 * Like a Quest item, each player can loot this key, and earn access to one of the Entwined Treasure Chests nearby which contain Abyss relics!
			 * In addition to the Entwined Treasure Chests, a Huge Entwined Chest will spawn beneath Dalia once it is defeated, which can be opened with the Swirl Key.
