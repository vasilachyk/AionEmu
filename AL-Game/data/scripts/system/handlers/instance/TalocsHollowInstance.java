...
public class TalocsHollowInstance extends GeneralInstanceHandler
{
	...
	private void spawnCrackedHugeInsectEgg() {
		SpawnTemplate IDElim3FEntity = SpawnEngine.addNewSingleTimeSpawn(300190000, 700739, 653.63f, 838.66998f, 1304.72f, (byte) 0);
	...
	private void spawnPurifiedFragmentOfAionTower() {
		SpawnTemplate AIONPieceCle = SpawnEngine.addNewSingleTimeSpawn(300190000, 700741, 636.35999f, 769.53003f, 1387.38f, (byte) 0);
		AIONPieceCle.setEntityId(92);
		objects.put(700741, SpawnEngine.spawnObject(AIONPieceCle, instanceId));
	}
	
	private void spawnGeyser() {
		SpawnTemplate IDElimWindBox = SpawnEngine.addNewSingleTimeSpawn(300190000, 281817, 653.77478f, 838.88306f, 1303.8502f, (byte) 0);
