	...
	public void onDie(Npc npc) {
		...
		switch (npc.getObjectTemplate().getTemplateId()) {
			...
			case 244096: //Enhanced Tough Sipus.
				points = 12000;
				despawnNpc(npc);
				SpawnTemplate kromedeOpenRoom1 = SpawnEngine.addNewSingleTimeSpawn(302000000, 834067, 292.34671f, 166.54131f, 119.53692f, (byte) 0);
			...
			case 244097: //Temple Guardian.
				points = 14400;
				despawnNpc(npc);
				SpawnTemplate kromedeOpenRoom2 = SpawnEngine.addNewSingleTimeSpawn(302000000, 834066, 169.24069f, 417.35110f, 140.77321f, (byte) 0);
