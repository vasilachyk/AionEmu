...
public class AturamSkyFortressInstance extends GeneralInstanceHandler
{
	...
	public void onDie(Npc npc) {
		...
		switch (npc.getObjectTemplate().getTemplateId()) {
			...
			/*case 702656: //Balaur Spy Crystal.
				...
				//The Spy Crystal has been destroyed.
				sendMsgByRace(1402739, Race.PC_ALL, 0);
				despawnNpc(npc);
			break;*/
	...
	private void spawnBarrierControler() {
		SpawnTemplate barrierControler = SpawnEngine.addNewSingleTimeSpawn(300240000, 701043, 815.66711f, 249.08171f, 603.10529f, (byte) 0);
	...
	private void spawnShulackFlitter() {
		SpawnTemplate shulackFlitter = SpawnEngine.addNewSingleTimeSpawn(300240000, 730390, 637.00262f, 497.52673f, 658.33716f, (byte) 0);
	...
	private void spawnActivatedBalaurTeleporter1() {
		SpawnTemplate activatedBalaurTeleporter1 = SpawnEngine.addNewSingleTimeSpawn(300240000, 702664, 352.29132f, 424.08679f, 655.7467f, (byte) 0);
	...
	private void spawnActivatedBalaurTeleporter2() {
		SpawnTemplate activatedBalaurTeleporter2 = SpawnEngine.addNewSingleTimeSpawn(300240000, 730392, 814.94f, 303.36319f, 603.42773f, (byte) 0);
