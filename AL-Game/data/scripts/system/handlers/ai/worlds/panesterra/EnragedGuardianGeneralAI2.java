...
public class EnragedGuardianGeneralAI2 extends AggressiveNpcAI2
{
	...
	protected void handleDied() {
		/**
		 * Enraged Guardian General "Ai2" coded because "Panesterra Fortress" are not considered like basic fortress.
		 * And so "Enraged Guardian General" does not pop chest after is dead.
		 */
		switch (getNpcId()) {
