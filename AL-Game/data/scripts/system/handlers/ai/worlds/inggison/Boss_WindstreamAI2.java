		...
		switch (getNpcId()) {
			...
			*/
			case 215584: //Titan Starturtle.
				announceWindBox();
				SpawnTemplate CastShadowPLSM = SpawnEngine.addNewSingleTimeSpawn(210050000, 281817, 338.26440f, 573.72168f, 458.27939f, (byte) 0);
			...
			case 216849: //Watcher Garma.
				announceWindBox();
				SpawnTemplate EnvWeatherShow = SpawnEngine.addNewSingleTimeSpawn(210050000, 281817, 2602.6992f, 1526.0367f, 258.13651f, (byte) 0);
			...
			case 216848: //Illanthe Hundredyears.
				announceWindBox();
				SpawnTemplate SkipOnLowSpec = SpawnEngine.addNewSingleTimeSpawn(210050000, 281817, 1745.8660f, 1716.3790f, 226.37808f, (byte) 0);
			...
			case 217071: //Esalki The Fourth.
				announceWindBox();
				SpawnTemplate EnvWeatherHide = SpawnEngine.addNewSingleTimeSpawn(210050000, 281817, 2288.1091f, 1067.0475f, 285.73407f, (byte) 0);
			...
			case 217072: //Huge Waterfall Starturtle.
				announceWindBox();
				SpawnTemplate DisplayFilled = SpawnEngine.addNewSingleTimeSpawn(210050000, 281817, 1660.0439f, 928.57129f, 404.99213f, (byte) 0);
			...
			*/
			case 216846: //Agrima.
				announceWindBox();
				SpawnTemplate FileLadderCGF = SpawnEngine.addNewSingleTimeSpawn(220070000, 281817, 1719.2194f, 2301.7344f, 318.70938f, (byte) 0);
