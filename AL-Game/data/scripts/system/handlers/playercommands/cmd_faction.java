	...
	public void execute(Player player, String... params) {
		...
		if (!PlayerChatService.isFlooding(player)) {
			if (player.getCommonData().getRace() == Race.ASMODIANS) {
				StringBuilder sbMessage = new StringBuilder("[Asmos] "+ ColorChat.colorChat(" Messages " , "4 0 2 0") + ColorChat.colorChat(player.getName() , "0 1 1 5") + " : ");
			...
			if (player.getCommonData().getRace() == Race.ELYOS) {
				StringBuilder sbMessage = new StringBuilder("[Elyos] " + ColorChat.colorChat(" Messages " , "4 0 2 0") + ColorChat.colorChat(player.getName() , "0 1 1 5") + " : ");
